...
- **Shareable Cards**: Download beautiful roast cards as images for social media sharing
...
- Follow the [Firebase AI Logic Getting Started Guide](https://firebase.google.com/docs/ai-logic/get-started?api=dev) to set up Firebase AI in your project
...
4. Add required assets to the `public` folder:
   - `/logo.png` - Your RoastBot logo
   - `/roastbot-icon.ico` - Favicon
   - `/fonts/Montserrat-Regular.ttf` - Montserrat font for OG images
   - `/desktop-bg.png` - Desktop background image
   - `/mobile-bg.png` - Mobile background image
...
- **AI/ML**: Firebase AI with Google Gemini 2.5 Flash
...
### RoastGenerator
Uses Firebase AI to generate roasts with customizable intensity levels:
...
- Vercel for OG image generation capabilities
